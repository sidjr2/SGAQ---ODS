...
import br.edu.ufsj.dcomp.sgaq.repository.AlunoRepository;
...
@Controller
@RequestMapping("/aluno") // Adicionando um mapeamento de nível de classe
public class AlunoController {
    ...
    public ModelAndView inserirAluno(@Valid Aluno aluno, BindingResult bindingResult) {
        ...
        modelAndView.setViewName("redirect:/aluno/alunos-adicionados");
    ...
    public ModelAndView editar(Aluno aluno) {
        ModelAndView modelAndView = new ModelAndView();
        alunoRepository.save(aluno);
        modelAndView.setViewName("redirect:/aluno/alunos-ativos");
        return modelAndView;
    }
    ...
    public String removerAluno(@PathVariable("id") Long id) {
        ...
        return "redirect:/aluno/alunos-ativos";
    }
    ...
    public ModelAndView pesquisa() {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("Aluno/pesquisa");
        return modelAndView;
    }
}
